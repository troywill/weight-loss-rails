...
* [4/4] Create an new rails application structure
  ...
  4. [X] Set the time zone file:../config/application.rb
     ...
     #+END_SRC
* [5/6] Create a User authentication system with Devise < see [[file:/troy@usahealthscience.com:/home/troy/srv/devise/128/emacs/emacs/step-by-step-devise.org][step-by-step-devise.org]] >
