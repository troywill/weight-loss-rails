...
* [/] Create a new rails application
  ...
  2. [ ] Enable a JavaScript runtime in [[file:Gemfile][./Gemfile]]
     ...
     #+END_SRC
  3. [ ] Set up database
     1. [ ] [[file:config/database.yml][./config/database.yml]]
        #+BEGIN_SRC conf
          default: &default
            adapter: postgresql
            encoding: unicode
        ...
        #+END_SRC
     2. [ ] rake db:create
* [/] Create a new rails application structure
...
* [/] Create a User authentication system with Devise < see [[file:/troy@usahealthscience.com:/home/troy/srv/devise/128/emacs/emacs/step-by-step-devise.org][step-by-step-devise.org]] >
  1. [ ] Enable `devise` gem in file:./Gemfile
     #+BEGIN_SRC conf
       gem 'devise', '~> 3.3.0' # August 13, 2014
     #+END_SRC
  2. [ ] bundle install
...
* [/] Layout to work with Bootstrap
  ...
  5. [ ] Hero unit file:./app/views/layouts/_hero_unit.html.erb
     ...
     #+END_SRC
  6. [ ] Create a Messages partial in file:./app/views/layouts/_messages.html.erb
     #+BEGIN_SRC html :tangle ./app/views/layouts/_messages.html.erb
       ...
       <% end %>
     #+END_SRC
  7. [ ] Create a "devise" partial in file:./app/views/layouts/_devise.html.erb
...
* [/] Create "Readings" model, controller, and views
  ...
  2. [ ] Limit readings to authenticated users [[file:../app/controllers/readings_controller.rb][app/controllers/readings_controller.rb]]
     ...
     #+END_SRC
  3. [ ] Relationship to User, validations [[file:../app/models/reading.rb][app/models/reading.rb]]
     #+BEGIN_SRC ruby
       belongs_to :user
       validates :user_id, :numericality => true
       validates :weight, :numericality => true
     #+END_SRC
  4. [ ] Default clothing in values in Model [[file:../db/migrate/][db/migrate/2012..._created_readings.rb]]
       #+BEGIN_SRC ruby
