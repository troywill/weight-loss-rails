* [/] Create a new rails application
  1. [0\/$1] Install Ruby on Rails 4
     1. [ ] Install ruby 2.0.0p0 (2013-02-24 revision 39474)
     2. [ ] sudo gem update (1m30s)
     3. [ ] sprockets
	#+BEGIN_SRC sh
	  sudo gem install sprockets --prerelease --no-ri --no-rdoc
	#+END_SRC
     4. [ ] sprockets-rails (17 gems installed)
	#+BEGIN_SRC sh
	...
	6. [ ] sudo gem install --local pkg/therubyracer-0.12.0beta1.gem
     8. [ ] sudo gem install devise --version 3.0.0.rc
     9. [ ] Run the 'rails' command as root
	#+BEGIN_SRC sh
  ...
  2. [ ] Create an new rails application structure
  3. [ ] Enable a JavaScript runtime in file:../Gemfile
     #+BEGIN_SRC ruby
...
* [/] Incorporate Twitter Bootstrap see  [[file:/scpc:troy@usahealthscience.com:/home/troy/srv/bootstrap/128/kehoe/emacs/][~/srv/bootstrap/128/kehoe/emacs/]]
   1. [ ] Install bootstrap-sass
	#+BEGIN_SRC sh
	  sudo gem install bootstrap-sass
	#+END_SRC
      - ( Successfully installed bootstrap-sass-2.3.1.0 Wed May  8 08:55:02 PDT 2013 )
   2. [ ] Add `bootstrap-sass` gems in [[file:../Gemfile][Gemfile]]
      #+BEGIN_SRC ruby
        gem 'bootstrap-sass'
      #+END_SRC
   ...
   8. [ ] Narrow select class width from 220px to 110px file:../app/assets/stylesheets/bootstrap_and_overrides.css.scss
      #+BEGIN_SRC css
        select { width: 110px; }
      #+END_SRC
* [/] Layout to work with boostrap see  [[file:/scpc:troy@usahealthscience.com:/home/troy/srv/bootstrap/128/kehoe/emacs/][~/srv/bootstrap/128/kehoe/emacs/]]
...
* [/] Create "Readings" model, controller, and views
  ...
  2. [ ] Relationship to User, validations
     ...
     #+END_SRC
  3. [ ] Default clothing in values in Model file:../db/migrate/ 2012..._created_readings.rb
       #+BEGIN_SRC ruby
