...
* [100%] Draw Google Graph
  ...
  5. [X] Place a chart_array method in Readings model file:../app/models/reading.rb
     ...
     - Commentary: :: We will pass data into Google javascript in the view
  6. [X] Put Google Graph javascript into view three day file:../app/views/google_graph/three_day.html.erb
     #+BEGIN_SRC html
  ...
  7. [X] Put 28 day Google Graph javascript into view file:../app/views/google_graph/month.html.erb
     #+BEGIN_SRC html
       <script type="text/javascript" src="https://www.google.com/jsapi"></script>
       <script type="text/javascript">
         google.load("visualization", "1", {packages:["corechart"]});
