...
* [2/2] Display current goal
  ...
  2. [X] View file:../app/views/home/index.html.erb
     ...
     #+END_SRC
* [6/6] Weight as a function of time
...
* [7/7] Draw Google Graph
  ...
  3. [X] Generate the controller for generating Graphs
     ...
     #+END_SRC
  4. [X] No turbolinks Google Graphs navigation file:../app/views/layouts/_navigation.html.erb layout
     #+BEGIN_SRC html
  ...
  8. [X] VIEW Call partial from 3 day, month, and 1 year views file:../app/views/google_graph/year.html.erb
     ...
     #+END_SRC
* [1/1] Display readings latest first
