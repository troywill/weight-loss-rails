...
TDW
     ...
     #+END_SRC
     - Commentary: :: We will pass data into Google javascript in the view
  5. [X] Put 28 day Google Graph javascript into view file:../app/views/google_graph/month.html.erb
     #+BEGIN_SRC html
       <script type="text/javascript" src="https://www.google.com/jsapi"></script>
       <script type="text/javascript">
         google.load("visualization", "1", {packages:["corechart"]});
         ...
         var options = { title: 'Weight 28 days' };
     ...
     #+END_SRC
     - var options={title:'Weight',pointSize:5,vAxis:{minValue: 180}};
  8. [ ] Path for Google Graph three day in navigation file:../app/views/layouts/_navigation.html.erb layout
     #+BEGIN_SRC html
       <li><div id="fuck-turbolinks" data-no-turbolink><%= link_to "3 day graph", google_graph_three_day_path %></div></li>
     #+END_SRC
  9. [ ] Create a goal as a function of time method, place in User model
     - file:../../app/models/user.rb
       ...
       #+END_SRC
  10. [ ] Add goal to month_array method in Reading model so it shows on the Google chart
