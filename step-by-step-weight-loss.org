...
* [30%] Draw Google Graph
  ...
  4. [X] Path for Google Graph three day in navigation file:../app/views/layouts/_navigation.html.erb layout
     ...
     #+END_SRC
  5. [ ] Place a chart_array method in Readings model file:../app/models/reading.rb
     #+BEGIN_SRC ruby
  ...
  6. [ ] Place a 3 day data array method in Readings controller file:../app/models/reading.rb
     #+BEGIN_SRC ruby
     ...
     #+END_SRC
     - Commentary: :: We will pass data into Google javascript in the view
  7. [ ] Put Google Graph javascript into view file:../app/views/google_graph/three_day.html.erb
     #+BEGIN_SRC html
  ...
  8. [ ] Use three day data array  file:../app/views/google_graph/three_day.html.erb
     #+BEGIN_SRC html
       - var data = google.visualization.arrayToDataTable(<%= raw Reading.three_day_data_array(current_user).to_json %> );
     #+END_SRC
  9. [ ] Put 28 day Google Graph javascript into view file:../app/views/google_graph/month.html.erb
     #+BEGIN_SRC html
       <script type="text/javascript" src="https://www.google.com/jsapi"></script>
       <script type="text/javascript">
         google.load("visualization", "1", {packages:["corechart"]});
     ...
     #+END_SRC
     - var options={title:'Weight',pointSize:5,vAxis:{minValue: 180}};
  10. [ ] Path for 28 day Google Graph three day in navigation file:../app/views/layouts/_navigation.html.erb layout
      #+BEGIN_SRC html
