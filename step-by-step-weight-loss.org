* [100%] Create a new rails application
  ...
  4. [X] Set the default route to home/index in file:../config/routes.rb
     #+BEGIN_SRC ruby
       root 'home#index'
     #+END_SRC
  5. [X] Set the time zone file:../config/application.rb
     #+BEGIN_SRC sh
       rake -D time
       rake time:zones:us
     #+END_SRC
...
* [100%] Draw Google Graph
  ...
  4. [X] Path for Google Graph three day in navigation file:../app/views/layouts/_navigation.html.erb layout
     ...
     #+END_SRC
  5. [X] Place a chart_array method in Readings model file:../app/models/reading.rb
     #+BEGIN_SRC ruby
     ...
     - Commentary: :: We will pass data into Google javascript in the view
  6. [X] Put Google Graph javascript into view a view partial three day file:../app/views/layouts/_google_graph.html.erb
     #+BEGIN_SRC html
  ...
  7. [X] Put google chart data array into controller file:../app/controllers/google_graph_controller.rb
     ...
     #+END_SRC
  8. [X] Call partial from 3 day, month, and 1 year views file:../app/views/google_graph/year.html.erb
     #+BEGIN_SRC html
       <%= render 'layouts/google_graph' %>
     #+END_SRC
* [85%] Incorporate Twitter Bootstrap see  [[file:/scpc:troy@usahealthscience.com:/home/troy/srv/bootstrap/128/kehoe/emacs/][~/srv/bootstrap/128/kehoe/emacs/]]
...
* [0%] SimpleForm
  ...
  2. [ ] file:../Gemfile
     #+BEGIN_SRC ruby
       gem 'simple_form'
     #+END_SRC
  4. [ ] Run the generator: see [[https://github.com/plataformatec/simple_form#twitter-bootstrap][simple_form#twitter-bootstrap]]
     #+BEGIN_SRC sh
