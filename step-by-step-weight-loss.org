* [2/2] Create a new rails application
  ...
  2. [X] Set up database
     ...
     4. [X] FILE file:./pg_hba.conf /etc/postgresql/8.4/main/pg_hba.conf
        ...
        #+END_SRC
* [4/4] Create a new rails application structure
  1. [X] Enable a JavaScript runtime in [[file:../Gemfile][Gemfile]]
     #+BEGIN_SRC ruby
  ...
  3. [X] Set the default route to home/index in [[file:../config/routes.rb][config/routes.rb]]
     #+BEGIN_SRC ruby
       root 'home#index'
     #+END_SRC
  4. [X] Set the time zone [[file:../config/application.rb][config/application.rb]]
     #+BEGIN_SRC sh
       rake --describe time
       rake time:zones:us
     #+END_SRC
...
** (Optional) create a user from console
   ...
   #+END_SRC
* [7/8] Incorporate Twitter Hero Bootstrap
   ...
   8. [ ] Narrow select class width from 220px to 110px file:../app/assets/stylesheets/bootstrap_and_overrides.css.scss
      #+BEGIN_SRC css
        select { width: 110px; }
      #+END_SRC
* [6/6] Layout to work with Bootstrap
  ...
  4. [X] Create a "hero_unit" partial in [[file:../app/views/layouts/_hero_unit.html.erb][app/views/layouts/_hero_unit.html.erb]]
     ...
     #+END_SRC
  5. [X] Create a Messages partial in file:../app/views/layouts/_messages.html.erb
     #+BEGIN_SRC html
       ...
       <% end %>
     #+END_SRC
  6. [X] Create a "devise" partial in [[file:../app/views/layouts/_devise.html.erb][app/views/layouts/_devise.html.erb]]
     #+BEGIN_SRC html
       <!DOCTYPE html>
       <html lang="en">
         <head>
...
* [6/6] SimpleForm
  ...
  2. [X] [[file:../Gemfile][Gemfile]]
     #+BEGIN_SRC ruby
       gem 'simple_form'
     #+END_SRC
  3. [X] Run the generator: see [[https://github.com/plataformatec/simple_form#twitter-bootstrap][simple_form#twitter-bootstrap]]
     #+BEGIN_SRC sh
     ...
     #+END_EXAMPLE
  4. [X] VIEW file:../app/views/readings/_form.html.erb
     #+BEGIN_SRC html
       <!-- <%= form_for(@reading) do |f| %> -->
       <%= simple_form_for(@reading, :html => { :class => 'form-horizontal' } ) do |f| %>
     #+END_SRC 
  5. [X] VIEW [[file:../app/views/readings/_form.html.erb][app/views/readings/_form.html.erb]]
     #+BEGIN_SRC html
       <!-- <div class="actions"> -->
       <!--   <%= f.submit %> -->
       <!-- </div> -->
     ...
     #+END_SRC
  6. [X] VIEW [[file:../app/views/readings/_form.html.erb][app/views/readings/_form.html.erb]]
     #+BEGIN_SRC html
       <%= f.input :weight %>
       <%= f.input :clothing_wt %>
     #+END_SRC
...
* [10/10] Create "Settings" model, controller, and views, default values
  ...
  10. [X] Add New Settings to be created when a new user is created [[file:../app/models/user.rb][app/models/user.rb]]
	...
	#+END_SRC
* [11/11] Create Goal model, controller, and views
  1. [X] Generate scaffold
     ...
     #+END_SRC
  2. [X] Layout file:../app/controllers/goals_controller.rb
  3. [X] Table class file:../app/views/goals/index.html.erb
     #+BEGIN_SRC html
       <table class="table">
     #+END_SRC
...
* [3/3] Display current goal
  ...
  3. [X] View [[file:../app/views/home/index.html.erb][app/views/home/index.html.erb]]
     #+BEGIN_SRC html
       <%= goal_now %>
     #+END_SRC
* [7/7] Weight as a function of time
