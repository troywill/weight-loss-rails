...
* [8/8] Layout to work with Bootstrap
  ...
  8. [X] Deploy to Heroku
     #+BEGIN_SRC sh
       ...
       git push heroku master
     #+END_SRC
* [9/9] Create "Readings" model, controller, and views
  ...
  8. [X] [[file:../app/controllers/readings_controller.rb][app/controllers/readings_controller.rb]] ( welcome controller, index method )
     ...
     #+END_SRC
  9. [X] Bootstrap table [[file:../app/views/readings/index.html.erb][app/views/readings/index.html.erb]]
     #+BEGIN_SRC html
       <table class="table">
     #+END_SRC
  10. [X] Deploy to Heroku
      #+BEGIN_SRC sh
        ...
        run rake db:migrate
      #+END_SRC
* [11/11] Create "Settings" model, controller, views, and default values
  ...
  11. [X] Deploy to Heroku
      #+BEGIN_SRC sh
        ...
        run rake db:migrate
      #+END_SRC
* [12/12] Create Goal model, controller, and views
...
* [9/9] Draw Google Graph
  ...
  5. [X] Write a class `chart_array` method in Readings [[file:../app/models/reading.rb][app/models/reading.rb]]
     #+BEGIN_SRC ruby
       def self.chart_array(user, number_of_intervals, interval )
         ...
         (0..number_of_intervals).each do |period_num|
           time_at_point_in_past = Time.now-(number_of_intervals-period_num) * interval
  ...
  7. [X] Put google chart data array into controller [[file:../app/controllers/google_graph_controller.rb][app/controllers/google_graph_controller.rb]]
     #+BEGIN_SRC ruby
       class GoogleGraphController < ApplicationController
         ...
         def hour
           @google_chart_data_array = Reading.chart_array(current_user,'Last hour',12,300).to_json
