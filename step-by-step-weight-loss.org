...
* [25%] Create "Settings" model, controller, and views, default values
  ...
  5. [ ] Add @user.id to create method file:../app/controllers/settings_controller.rb
     #+BEGIN_SRC ruby
       def create
  ...
  10. [ ] Relationship between Setting and User file:../app/models/setting.rb
      #+BEGIN_SRC ruby
        class Setting < ActiveRecord::Base
          belongs_to :user
          ...
      #+END_SRC
  11. [ ] Relationship between User and Setting file:../app/models/user.rb
      #+BEGIN_SRC ruby
        class User < ActiveRecord::Base
          has_one :setting
      #+END_SRC
  12. [ ] Add New Settings to be created when a new user is created file:../app/controllers/users_controller.rb
      #+BEGIN_SRC ruby
        def create
