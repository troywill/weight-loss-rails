...
* TODO [3/9] Draw a graph
  ...
  4. [X] cd into plugins and run gem unpack gruff
  5. [ ] rails generate controller WeightGraph week month year
  6. [ ] In file:../../config/environment.rb add require 'gruff' after the ::Application.initialize! line
